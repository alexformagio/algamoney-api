...
public class AlgaMoneyExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String mensagemDev = ex.getCause() != null ? ex.getCause().getMessage() : ex.toString();
		List<Erro> listaErro = Arrays.asList(new Erro(mensagemUser, mensagemDev));
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		List<Erro> listaErros = criaListaErros(ex.getBindingResult()); 
	...
	private List<Erro> criaListaErros(BindingResult bindingResults){
		...
		for(FieldError fieldError: bindingResults.getFieldErrors()) {
			...
			listaErros.add(new Erro(messageUser, messageDev));
		}
		return listaErros;
	}
